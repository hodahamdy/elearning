                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form class="form form-horizontal" method="POST" action="{{ route('entrysection.store' ) }}" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="row">
                                                             <div class="col-12">
                                                                <div class="mb-1 row">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="mb-1 row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control" name="pragraph" />
